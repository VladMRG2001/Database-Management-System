...
<?php
		...
		?>	
	<p> Adaugare Parinte in baza de date </p>
				
	<form action="insert_parinte.php" method="post" class="formular" id="ex3" name="register_form"> 
		<div >
...
<?php
		...
		?>		
<p> Adaugare Vestimentatie in baza de date </p>
				
	<form action="insert_vestimentatie.php" method="post" class="formular" id="ex3" name="register_form"> 
		<div >
